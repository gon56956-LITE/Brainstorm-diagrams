...
```powershell
python scripts\generate_diagram.py templates\fishbone.template.json output.svg
```

Markdown input works the same way:

```powershell
python scripts\generate_diagram.py templates\fishbone.template.md output.svg
```

Fault tree templates render through the same dispatcher:

```powershell
python scripts\generate_diagram.py templates\fault-tree.template.json output.svg
```
...
```powershell
python scripts\generate_diagram.py templates\fault-tree.template.md output.svg
```
