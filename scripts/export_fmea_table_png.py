#!/usr/bin/env python3
"""Export a work/fmea-table/ SVG to PNG using the bundled Python runtime."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export work/fmea-table/<name>.svg to PNG.")
    parser.add_argument("name", help="Diagram name, such as process-fmea")
