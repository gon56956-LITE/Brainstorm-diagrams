#!/usr/bin/env python3
"""Export a work/roadmap-timeline/ SVG to PNG using the bundled Python runtime."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export work/roadmap-timeline/<name>.svg to PNG.")
    parser.add_argument("name", help="Diagram name, such as product-roadmap")
