#!/usr/bin/env python3
"""Export a work/two-by-two-matrix/ SVG to PNG using the bundled Python runtime."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export work/two-by-two-matrix/<name>.svg to PNG.")
    parser.add_argument("name", help="Diagram name, such as action-priority")
