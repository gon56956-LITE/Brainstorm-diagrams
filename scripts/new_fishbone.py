#!/usr/bin/env python3
"""Create a new fishbone workspace input from a template and render its SVG."""
...
def main() -> int:
    ...
    template_path = TEMPLATES / f"fishbone.template.{args.format}"
    ...
    print(f'& "{PYTHON}" scripts\\generate_diagram.py {input_path.relative_to(ROOT)} {output_path.relative_to(ROOT)}')
    return 0
